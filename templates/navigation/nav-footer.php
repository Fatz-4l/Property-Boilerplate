    ...
    <div class="container">
        ...
        <nav class="mb-8">
            ...
            wp_nav_menu([
                ...
                'menu_class'     => 'flex flex-wrap items-center text-center justify-center gap-x-8 gap-y-4 text-black',
            ]);
            ?>
        </nav>
        ...
        <div class="text-center flex flex-col md:flex-row items-center justify-center text-sm text-black">
            <div class="mb-4 md:mb-0">
                © <?php echo date('Y'); ?> WP Property Boilerplate By DNA. All rights reserved.
            </div>
        </div>
    </div>
</footer>